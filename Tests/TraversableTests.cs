...
namespace Tests
{
    ...
    public class TraversableTests : IClassFixture<TraversableFixture>
	{
		...
		public TraversableTests(TraversableFixture fixture)
		{
		...
		public void ExtensionsRetrieveRelatedNodes()
		{
			...
			var rootWithChildren = new List<Traversable>() { root };
			...
			var descendants = new List<Traversable>() { root };
			...
			var ancestors = new List<Traversable>() { grandchild, firstChild, root };
