...
namespace Tests
{
	public class TraversableTraverserTests : IClassFixture<TraversableFixture>
	{
		private readonly TraversableFixture fixture;

		public TraversableTraverserTests(TraversableFixture fixture)
		{
		...
		public void TraverserIgnoresNode()
		{
			...
			var expectedNodes = new List<Traversable>() { root };
		...
		public void TraverserReversesOrderOfChildNodes()
		{
			...
			var expected = new List<Traversable>() { root, secondChild, firstChild };
